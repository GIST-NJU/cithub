...
<template>
    ...
    <main class="main-content position-relative border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <!-- 1. statistic -->
            <div class="row default_cursor_land">
                <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4 default_cursor_land">
                    <div class="card">
                        <div class="card-body p-3 default_cursor_land">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers default_cursor_land">
                                        <p class="mb-1 font-weight-bolder text-lg">Research Papers</p>
                                        <h5 class="font-weight-bolder default_cursor_land">{{ paginationObj.total }}</h5>
                                        <i class="fa fa-arrow-up text-info default_cursor_land"></i>
                                        <span class="text-info font-weight-bolder default_cursor_land">+3%</span>
                                        since last year
                                    </div>
                                </div>
                                <div class="col-4 text-end default_cursor_land">
                                    <div
                ...
                <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4 default_cursor_land">
                    <div class="card">
                        <div class="card-body p-3 default_cursor_land">
                            <div class="row">
                                <div class="col-8 default_cursor_land">
                                    <div class="numbers default_cursor_land">
                                        <p class="mb-1 font-weight-bolder text-lg default_cursor_land">Scholars</p>
                                        <h5 class="font-weight-bolder default_cursor_land">{{
