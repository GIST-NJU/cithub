            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4" style="height:100%">
                        <h3 style="margin: 20px 0px 0px 40px;">Categories List</h3>
                        <div class="card-header pb-0">
                            <div style="display:flex;flex-direction: row;;">
                                <div v-for="(category,index) in CategoryArray_1" class="category" @click=selectCategory(category.category)>
                            ...
                            <div style="display:flex;flex-direction: row;;">
                                <div v-for="(category,index) in CategoryArray_2" class="category" @click=selectCategory(category.category)>
                                    <el-card class="box-card" style="height: 100%;">
                                        <template #header>
                                            <div class="card-header" style="padding: 10px 0px 0px 10px;">
                                                <h5>{{ category.category }}</h5>
                            ...
                            <div style="display:flex;flex-direction: row;;">
                                <div v-for="(category,index) in CategoryArray_3" class="category" @click=selectCategory(category.category)>
                                    <el-card class="box-card" style="height: 100%;">
                                        <template #header>
                                            <div class="card-header" style="padding: 10px 0px 0px 10px;">
                                                <h5>{{ category.category }}</h5>
