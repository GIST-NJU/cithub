<template>
  <div class="card">
    <div class="card-header pb-0">
      <h5>{{ testSuitesStore.testSuitesList.length }} test suites (strength {{ currentModel.currentModel.strength }})
        generated by the above model found.</h5>
    </div>
          ...
          <tbody>
            <tr class="cardTR" v-for="(testSuite, index) in testSuitesStore.testSuitesList">
              ...
              <td class="align-middle">
                <a class="btn btn-link text-dark px-3 mb-0" @click="EnterTestSuiteDetails(testSuite)">
                  <i class="fas fa-book-open text-primary me-2" aria-hidden="true"></i>Details
                </a>

                <!-- <a class="btn btn-link text-dark px-3 mb-0" @click="EnterTestSuite(testSuite)">
                  <i class="fas fa-book-reader text-success me-2" aria-hidden="true"></i>Evaluation
                </a>

                <a class="btn btn-link text-dark px-3 mb-0" @click="EnterTestSuite(testSuite)">
                  <i class="fas fa-blender-phone text-info me-2" aria-hidden="true"></i>Prioritisation
                </a>
