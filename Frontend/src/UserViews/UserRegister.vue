            ...
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form">
                                <argon-input type="text" placeholder="Please input your name" aria-label="Name"
                                    :isRequired="true" />
                                <argon-input type="text" placeholder="Please input your Institution" aria-label="Name"
                                    :isRequired="true" />
                                <argon-input type="email" placeholder="Please input your email" aria-label="Email"
                                    :isRequired="true" />
                                <argon-input type="text" placeholder="Please input your account" aria-label="Email"
                                    :isRequired="true" />
                        
                                <argon-input type="password" placeholder="Password" aria-label="Password"
                                    :isRequired="true" />
                                <argon-input type="password" placeholder="Password again" aria-label="Password"
                                    :isRequired="true" />
                                ...
                                <p class="text-sm mt-3 mb-0">
                                    ...
                                    <a  @click="jumpToLogin" style="cursor: pointer;" class="text-dark font-weight-bolder">Sign in</a>
                                </p>
